...
def run_giwaxs_Kim(t=1): 
    ...
    sample_list = ['7-1_wideangle_10nm_MIM', '7-2_wideangle_20nm_MIM', '7-3_wideangle_4nm_MIM', '7-4_wideangle_Hf0.75', '7-5_wideangle_Hf0.25','7-6_wideangle_ZrO2']
    ...
    waxs_angle_array = np.linspace(0, 84, 15)   # q=4*3.14/0.77*np.sin((max angle+3.5)/2*3.14159/180)
