...
## change pz to 5400 
# in vacuum
sample_dict = {  1:  'Wat_GCap1p5mm', 2: 'Gao_S1_7', 3: 'Xu_SBK_1', 4: 'Xu_SBK_2', 5: 'Xu_S5', 6: 'Xu_S6', 7: 'Xu_S7', 8: 'Xu_S8',
 9: 'Xu_S9', 10: 'Xu_S10', 11: 'Xu_S11', 12: 'Xu_S12', 13: 'Xu_S13', 14: 'Xu_S14', 15: 'Xu_S15', 
 16: 'Au5_Stock_GCap1p5mm' ,  17: 'Au10_Stock_GCap1p5mm' , 18: 'Au15_Stock_GCap1p5mm',    19: 'Au20_Stock_GCap1p5mm', 
 20: 'Au30_Stock_GCap1p5mm',   21: 'Au50_Stock_GCap1p5mm',   22: 'Al2O3', 23:'AgBH', 24:  'YM_blue_powder',
 }
...
# in vacuum
sample_dict = {   1: 'Xu_S1', 2: 'Xu_S2', 3: 'Xu_S3', 4: 'Xu_S4', }
...
2: 'Xu_S2_InAir', 3: 'Xu_S3_InAir', 4: 'Xu_S4_InAir', }
...
## change pz to 5400 
# in air
sample_dict = {  1:  'Wat_GCap1p5mm_InAir', 2: 'Gao_S1_7_InAir', 3: 'Xu_SBK_1_InAir', 4: 'Xu_SBK_2_InAir', 5: 'Xu_S5_InAir',
 6: 'Xu_S6_InAir', 7: 'Xu_S7_InAir', 8: 'Xu_S8_InAir',
 9: 'Xu_S9_InAir', 10: 'Xu_S10_InAir', 11: 'Xu_S11_InAir', 12: 'Xu_S12_InAir', 13: 'Xu_S13_InAir', 14: 'Xu_S14_InAir', 15: 'Xu_S15_InAir', 
 16: 'Au5_Stock_GCap1p5mm_InAir' ,  17: 'Au10_Stock_GCap1p5mm_InAir' , 18: 'Au15_Stock_GCap1p5mm_InAir',    19: 'Au20_Stock_GCap1p5mm_InAir', 
 20: 'Au30_Stock_GCap1p5mm_InAir',   21: 'Au50_Stock_GCap1p5mm_InAir',   22: 'Al2O3_InAir', 23:'AgBH_InAir', 24:  'YM_blue_powder_InAir',
 } 
ypos = 100
dx = 0
pxy_dict = {       
...
sample_dict = {   1: 'Fang_HXNPin_Sample',   } 
pxy_dict = {       
1:  ( -200, -5350  ) ,
}
...
##Run6, 
sample_dict = {   1: 'YM_Crab_Test_Air',   } 
pxy_dict = {       
1:  ( 2200, 0   ) ,
}
...
def measure_prs_rotate_waxs( k ,  wa=0,  t=.1 ):
    move_waxs( wa )
...
def _measure_one_prs_waxs(  k, dets,  t =  1    ):    
    ...
    x_pos=piezo.x.position, y_pos=piezo.y.position, z_pos=piezo.z.position,                   
                ...
                prsa = prsa, waxs_angle=waxs_angle, expt= t, 
