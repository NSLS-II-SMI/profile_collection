def waxs_S_edge_Gregory_2022_2(t=0.5):
    ...
    names_a = ['0_pristine', '1_hT', '2_hT-6', '3_hT-25', '4_hT-400', '5_hTe', '6_hPTe-1pt5', '7_hTe-3', '8_hTe_400', '9_sintu30_reverse', '10_sintu50_reverse']
    ...
    names_b = ['11_hB', '12_hB-1pt5', '13_hB-3', '14_hB-400', '15_copoly', '16_copoly-1pt5', '17_copoly-3','18_copoly-400','19_sintu70_reverse','20_sintu90_reverse']
    ...
    energies = np.arange(2448, 2478, 5).tolist() + np.arange(2478, 2488, 0.25).tolist()+ np.arange(2488, 2498, 1).tolist()+ np.arange(2498, 2503, 5).tolist()
    ...
    for name, xs, ys in zip(names, x, y):
        ...
        for wa in waxs_arc:
            ...
            for e, xsss, ysss in zip(energies, xss, yss): 
                ...
                sample_name = name_fmt.format(sample=name, energy='%6.2f'%e, wax=str(wa).zfill(4),
...
def waxs_Te_edge_Gregory_2022_2(t=0.35):
   ...
   # y_b = [5000, 5000, 4470, 4900, 4900, 4850]
    ...
    energies = np.arange(4320, 4345, 5).tolist() + np.arange(4345, 4350, 2.5).tolist() + np.arange(4350, 4360, 0.4).tolist()+ np.arange(4360, 4380, 2).tolist()+ np.arange(4380, 4400, 5).tolist()
...
def waxs_Ca_edge_Gregory_2022_2(t=0.5):
    ...
    energies = np.arange(4030, 4040, 5).tolist() + np.arange(4040, 4050, 0.25).tolist()+ np.arange(4050, 4060, 1).tolist()+ np.arange(4060, 4070, 2.5).tolist() + np.arange(4070, 4080, 5).tolist()
...
def run_waxs_simple_2022_2(t=1):
    ...
    samples = ['0_blank', '1_Au1', '2_Au3thin', '4_alkyl', '5_Bquick', '6_DEG', '7_Au3thick', '8_F1thick', '9_Bslow']
