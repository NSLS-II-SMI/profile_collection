...
def ex_situ(meas_t = 1):
    x_list_E = [38800, 32400, 26100, 19400, 13400, 6900, 600, -5700, -12100, -18400, -25200, -31500, -37500, -44100]
    sample_list_E = ['PbS22B_FICO_7A2_2to1_1pcOA_10mM_SDS', 'PbS22B_FICO_7A2_3to1_1pcOA_10mM_SDS', 'PbS22B_FICO_7A2_4p5to1_1pcOA_10mM_SDS','PbS25_PbS15_2to1_1pcoA_10mM_SDS','PbS25_PbS15_1to1_1pcOA_10mM_SDS','PbS25_PbS15_1to2_1pcOA_10mM_SDS', 'PbS16_PbS15_2to1_1pcOA_10mM_SDS','PbS16_PbS15_1to1_1pcOA_10mM_SDS','PbS16_PbS15_1to2_1pcOA_10mM_SDS','PbS22B_Fe3O4-11_1to1_1pcOA_10mM_SDS','PbS22B_Fe3O4-11_2to1_1pcOA_10mM_SDS','PbS22B_Fe3O4-11_13to1_1pcOA_10mM_SDS','PbS22B_Fe3O4-14_1to1_1pcOA_10mM_SDS','PbS22B_Fe3O4-14_1to2_1pcOA_10mM_SDS']
    ...
    for x, sample in zip(x_list_E, sample_list_E): #loop over samples on bar
        ...
        sample_name = name_fmt.format(sample=sample, x_pos=np.round(piezo.x.position,2), y_pos=np.round(piezo.y.position,2), saxs_z=np.round(pil1m_pos.z.position,2), meas_t=meas_t, scan_id=RE.md['scan_id'])
...
sample_list = [ 'Au10_FF', 'Au10FCC_50', 'Au10FCC_100', 'Au10FCC_150', 'Au10FCC_200', ]
##150 should be 200
##200 should be 500
...
def in_situ(meas_t = 1, t0=0):
    ...
    sample_list = ['Kin40_Fe11_PbS22B_1to2_hextol_noOA_200mM-SDS_70C', 'Kin39_FICO6C_PbS26_1to3_hextol_noOA_200mM-SDS_70C', 'Kin38_FICO6C_PbS26_1to3p86_hextol_noOA_200mM-SDS_70C', 'Kin37_FICO7B2_PbS26_1to6_hextol_noOA_200mM-SDS_70C']
    ...
    for ii in range(50000):
        for y, sample in zip(y_list, sample_list): #loop over samples on bar
            ...
            name_fmt = '{sample}_x{x_pos}_y{y_pos}_sax{saxs_z}m_{meas_t}s_t{t}s_{scan_id}'
            sample_name = name_fmt.format(sample=sample, x_pos=np.round(piezo.x.position,2), y_pos=np.round(piezo.y.position,2), saxs_z=np.round(pil1m_pos.z.position,2), meas_t=meas_t, t=np.round(time.time()-t0, 0), scan_id=scan_id0+count )
            count = count+1
