...
# 4 th run,
ypos = 4389  # 5099 
sample_dict = {  1: 'Fe3O4_OO_LC',   }
pxy_dict = {  1:  ( 49100, ypos  ),    }
# run 5 
ypos = 4039
sample_dict = {   2: 'Fe3O4_LC1', 3: 'Fe3O4_LC2', 4: 'Fe3O4_LC3', 5: 'Fe3O4_916', 6: 'Fe3O4_1017', 7: 'Au_azo_G1', 8:'Au_azo_G2', 9:'Au_G1' }
pxy_dict = {   2:   ( 39100, ypos  ), 3:  ( 30100, ypos  ), 4:  ( 19100, ypos  ), 5:
 ( 10100, ypos  ), 6:  ( 1100, ypos ) , 7: (-10900, ypos ), 8: (-21900, ypos)  , 9:(-33900, ypos)  }
...
##Run 42, In_situ HT
ypos = 6644
sample_dict = {  1: 'TestSample1_T50', 2: 'TestSample2_T50',      }
pxy_dict = {  1:  (-700, ypos  ), 2:  (27300, 6300  ),   }
...
##Run 43, In_situ HT
ypos = 6644
sample_dict = {  1: 'Au_LC1_RT', 2: 'Au_LC2_RT', 3: 'Au_LC3_RT', 4: 'Au_LC4_RT',     }
pxy_dict = {  1:  (-15700, ypos  ), 2:  (-700, ypos  ), 3:  (16300, ypos  ), 4:  (31300, 6300  ),  }
# run_gisaxs_in_situHT()
...
ypos = 6744
sample_dict = {  1: 'Au_LC1_RT', 2: 'Au_LC2_RT', 3: 'Au_LC3_RT', 4: 'Au_LC4_RT',     }
pxy_dict = {  1:  (-17700, 6744  ), 2:  (-3700, 6744  ), 3:  (12300, 6744  ), 4:  (30300, 6744  ),  }
# run_gisaxs_in_situHT()

##Run 45, In_situ HT 01:45 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_50', 2: 'Au_LC2_50', 3: 'Au_LC3_50', 4: 'Au_LC4_50',     }
pxy_dict = {  1:  (-17700, 6744  ), 2:  (-3700, 6744  ), 3:  (12300, 6744  ), 4:  (30300, 6744  ),  }
# run_gisaxs_in_situHT()

##Run 45, In_situ HT 02:25 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_70', 2: 'Au_LC2_70', 3: 'Au_LC3_70', 4: 'Au_LC4_70',     }
pxy_dict = {  1:  (-17700, 6744  ), 2:  (-3700, 6744  ), 3:  (12300, 6744  ), 4:  (30300, 6744  ),  }
# run_gisaxs_in_situHT()
...
ypos = 6744
sample_dict = {  1: 'Au_LC1_90', 2: 'Au_LC2_90', 3: 'Au_LC3_90', 4: 'Au_LC4_90',     }
pxy_dict = {  1:  (-17700, 6744  ), 2:  (-3700, 6744  ), 3:  (12300, 6744  ), 4:  (30300, 6744  ),  }
# run_gisaxs_in_situHT()

##Run 47, In_situ HT 03:45 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_110', 2: 'Au_LC2_110', 3: 'Au_LC3_110', 4: 'Au_LC4_110',     }
pxy_dict = {  1:  (-17700, 6744  ), 2:  (-3700, 6744  ), 3:  (12300, 6744  ), 4:  (30300, 6744  ),  }
# run_gisaxs_in_situHT()
...
ypos = 6744
sample_dict = {  1: 'Au_LC1_50_cool', 2: 'Au_LC2_50_cool', 3: 'Au_LC3_50_cool', 4: 'Au_LC4_50_cool',     }
pxy_dict = {  1:  (-17700, 6744  ), 2:  (-3700, 6744  ), 3:  (12300, 6744  ), 4:  (30300, 6744  ),  }
# run_gisaxs_in_situHT()
...
ypos = 6744
sample_dict = {  1: 'Au_LC1_RT_cool', 2: 'Au_LC2_Rt_cool', 3: 'Au_LC3_Rt_cool', 4: 'Au_LC4_Rt_cool',     }
pxy_dict = {  1:  (-17700, 6744  ), 2:  (-3700, 6744  ), 3:  (12300, 6744  ), 4:  (30300, 6744  ),  }
# run_gisaxs_in_situHT()

##Run 50, In_situ HT 05:15 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_5CB_RT', 2: 'Au_LC2_5CB_RT', 3: 'Au_LC3_5CB_RT', 4: 'Au_LC4_5CB_RT',  5: '5CB_RT',    }
pxy_dict = {  1:  (-20700, 6744  ), 2:  (-9700, 6744  ), 3:  (5300, 6744  ), 4:  (20300, 6744  ), 5:  (33300, 6744  )  }
# run_gisaxs_in_situHT()


##Run 51, In_situ HT 05:53 211030
ypos = 6744
sample_dict = {  1: 'Pt_LC1_RT', 2: 'Pt_LC2_RT', 3: 'Pt_LC3_RT', 4: 'Pt_LC4_RT',   }
pxy_dict = {  1:  (-16700, 6744  ), 2:  (-1700, 6744  ), 3:  (12300, 6744  ), 4:  (31300, 6744  ),   }
# run_gisaxs_in_situHT()

##Run 52, In_situ HT 06:15 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_5CB_RT_1', 2: 'Au_LC2_5CB_RT_1', 3: 'Au_LC3_5CB_RT_1', 4: 'Au_LC4_5CB_RT_1',  5: '5CB_RT_1',    }
pxy_dict = {  1:  (-20700, 6744  ), 2:  (-7700, 6744  ), 3:  (6300, 6744  ), 4:  (20300, 6744  ), 5:  (33300, 6744  )  }
# run_gisaxs_in_situHT()


##Run 53, In_situ HT 06:35 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_5CB_50_1', 2: 'Au_LC2_5CB_50_1', 3: 'Au_LC3_5CB_50_1', 4: 'Au_LC4_5CB_50_1',  5: '5CB_50_1',    }
pxy_dict = {  1:  (-20700, 6744  ), 2:  (-7700, 6744  ), 3:  (6300, 6744  ), 4:  (20300, 6744  ), 5:  (33300, 6744  )  }
# run_gisaxs_in_situHT()

##Run 54, In_situ HT 06:55 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_5CB_80_1', 2: 'Au_LC2_5CB_80_1', 3: 'Au_LC3_5CB_80_1', 4: 'Au_LC4_5CB_80_1',  5: '5CB_80_1',    }
pxy_dict = {  1:  (-20700, 6744  ), 2:  (-7700, 6744  ), 3:  (6300, 6744  ), 4:  (20300, 6744  ), 5:  (33300, 6744  )  }
# run_gisaxs_in_situHT()

##Run 55, In_situ HT 06:55 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_5CB_110_1', 2: 'Au_LC2_5CB_110_1', 3: 'Au_LC3_5CB_110_1', 4: 'Au_LC4_5CB_110_1',  5: '5CB_110_1',    }
pxy_dict = {  1:  (-20700, 6744  ), 2:  (-7700, 6744  ), 3:  (6300, 6744  ), 4:  (20300, 6744  ), 5:  (33300, 6744  )  }
# run_gisaxs_in_situHT()

##Run 56, In_situ HT 07:40 211030
ypos = 6744
sample_dict = {  1: 'Au_LC1_5CB_50_cool_1', 2: 'Au_LC2_5CB_50_cool_1', 3: 'Au_LC3_5CB_50_cool_1', 4: 'Au_LC4_5CB_50_cool_1',  5: '5CB_50_cool_1',    }
pxy_dict = {  1:  (-20700, 6744  ), 2:  (-7700, 6744  ), 3:  (6300, 6744  ), 4:  (20300, 6744  ), 5:  (33300, 6744  )  }
# run_gisaxs_in_situHT()
...
ypos = 0
sample_dict = {   1: 'Au-Azo-G1-Si-_SVA-1' , 2: 'Pt-Fe3O4-slow-vap-Si-SVA-1' , 3: 'Ai-Azo-G2-Si_SVA-1'   }
...
ypos = 0
sample_dict = {   1: 'Au-Azo-G1-Si-_SVA-2' , 2: 'Pt-Fe3O4-slow-vap-Si-SVA-2' , 3: 'Ai-Azo-G2-Si_SVA-2'   }
pxy_dict = {    1:  (-14000, 450  ) , 2:  (5400, 500  ) , 3: (23000, 300 ) }


##Run69 Au-Azo-G2 on Si drop cast 50 ul 1:00 UV on 1:22
ypos = 0
sample_dict = {   1: 'Au-Azo-G1-Si-_Spin-2' , 2: 'Au-Azo-G2-slow-vap-Si-SVA-2' , 3: 'Ai-Azo-G2-Si_SVA-3'   }
pxy_dict = {    1:  (-14000, 500  ) , 2:  (5400, 500  ) , 3: (23000, 300 ) }


##Run70 Au-Azo-G2 on Si drop cast 50 ul 1:00 UV on 1:22 CHCl3 01:39 UV off 2:05
ypos = 0
sample_dict = {   1: 'Au-Azo-G1-Si-_Spin-SVA-2' , 2: 'Au-Azo-G2-slow-vap-Si-SVA-3' , 3: 'Ai-Azo-G2-Si_SVA-4'   }
...
##Run78 Pt-Fe3O4 slow
ypos = 0
sample_dict = {   1: 'Au-LC1-RT-Si-1' , 2: 'Au-LC2-RT-Si-1'  , 3: 'Au-LC3-RT-Si-1' , 4: 'Au-LC4-RT-Si-1'  , 5: 'Au-G1-RT-Si-1'     }
pxy_dict = {    1:  (-11000, 6800  ) ,2:  (3000, 6800  ),3:  (17000, 6800  ) ,4:  (30000, 6800  ),5:  (43000, 6800 ) }

##Run79 Pt-Fe3O4 slow
ypos = 0
sample_dict = {   1: 'Au-LC1-40-Si-1' , 2: 'Au-LC2-40-Si-1'  , 3: 'Au-LC3-40-Si-1' , 4: 'Au-LC4-40-Si-1'  , 5: 'Au-G1-40-Si-1'     }
pxy_dict = {    1:  (-11000, 6800  ) ,2:  (3000, 6800  ),3:  (17000, 6800  ) ,4:  (30000, 6800  ),5:  (43000, 6800 ) }


##Run80 Pt-Fe3O4 slow
ypos = 0
sample_dict = {   1: 'Au-LC1-80-Si-1' , 2: 'Au-LC2-80-Si-1'  , 3: 'Au-LC3-80-Si-1' , 4: 'Au-LC4-80-Si-1'  , 5: 'Au-G1-80-Si-1'     }
pxy_dict = {    1:  (-11000, 6800  ) ,2:  (3000, 6800  ),3:  (17000, 6800  ) ,4:  (30000, 6800  ),5:  (43000, 6800 ) }


##Run81 Pt-Fe3O4 slow
ypos = 0
sample_dict = {   1: 'Au-LC1-120-Si-1' , 2: 'Au-LC2-120-Si-1'  , 3: 'Au-LC3-120-Si-1' , 4: 'Au-LC4-120-Si-1'  , 5: 'Au-G1-120-Si-1'     }
pxy_dict = {    1:  (-11000, 6800  ) ,2:  (3000, 6800  ),3:  (17000, 6900  ) ,4:  (30000, 6800  ),5:  (43000, 6800 ) }
...
def run_gisaxs_in_situSVP(  N = 200, sleep_time = 2,    x_list=x_list, sample_list=sample_list,   
    expt = 1, username =  username, inc_angles=[  0.05, 0.15, 0.3 ],   x_shift_array = [ -1000, 0, 1000  ]  ):
            ...
            for x_meas in x_pos_array: # measure at a few x positions
                ...
                for iii, th in enumerate(th_meas): #loop over incident angles
                    ...
                    sample_name = name_fmt.format(
                                sample = sample, th=th_real[iii], ts=ts, dt=treal, 
                                 x=np.round(piezo.x.position,2), y=np.round(piezo.y.position,2), 
                                z=np.round(piezo.z.position,2),  saxs_z=np.round(pil1m_pos.z.position,2), 
                                t=expt, scan_id = RE.md['scan_id']     )  
                    print( sample_name )            
...
def run_gisaxs_in_situ_evap(  N = 200, sleep_time = 10,    
    x_list=x_list, sample_list=sample_list,    t=1, username =  username, inc_angles=[  0.05, 0.15, 0.3, 0 ],
...
def run_gisaxs_in_situHT(  N = 1, sleep_time = 10,    
    x_list=x_list, sample_list=sample_list,    t=1, username =  username, inc_angles=[  0.05, 0.15, 0.3 ],
    x_shift_array = [ -1000, 0, 1000  ]  ):
...
def run_in_situ_RT_UV_swaxs(  sample_name =  sample_name, dx=0,  N = 200, sleep_time = 10, dead_time =  90, uv_time = 120 ):
    t0 = time.time()
    for i in range(N):        
        ti = time.time()
        ...
        RE(  bps.mv(waxs, 20 ) )           
        RE( measure_saxs( t = 1.1, att='None', dx=dx, dy=0, user_name=username, sample= sample_i )  ) 
...
def run_in_situ_HT_swaxs_single(  sample_i , dx=0,   ):
        RE(  bps.mv(waxs, 20 ) )           
        RE( measure_saxs( t = 1.1, att='None', dx=dx, dy=0, user_name=username, sample= sample_i )  ) 
        #run WAXS, if not run, just put a # in front of this line
        RE( measure_waxs( t = 1.1, waxs_angle=20, att='None', dx=dx, dy=0, user_name=username, sample= sample_i )  )    
...
def run_in_situ_HT_swaxs(  sample_name =  sample_name, dx=0,  N = 200, sleep_time = 10,   ):
    t0 = time.time()
    td = time.gmtime()
    ts= time.strftime("%Y-%m-%d-%H-%M-%S", td)
    print( ts  )
...
def run_in_situ_RT_saxs(  sample_name=sample_name , dx=0, N = 100, sleep_time = 10, dead_time =8 * 60  ):
    t0 = time.time()
    for i in range(N):        
        ti = time.time()
        treal = ti - t0 + dead_time
...
def run_in_situ_RT_waxs(  sample_name =  sample_name , dx=0, N = 100, sleep_time = 10, dead_time =8 * 60  ):
    t0 = time.time()
    for i in range(N):        
        ti = time.time()
        treal = ti - t0 + dead_time
...
def run_in_situ_RT_swaxs(  sample_name =  sample_name, dx=0,  N = 100, sleep_time = 10, dead_time =  90 ):
    t0 = time.time()
    for i in range(N):        
        ti = time.time()
        treal = ti - t0 + dead_time
...
def run_gisaxs(  x_list=x_list, sample_list=sample_list,    t=1, username =  username, inc_angles=[  0.05, 0.15, 0.3 ], 
    ...
    for ii, (x, sample) in enumerate(zip(x_list,sample_list)): #loop over samples on bar
        ...
        for x_meas in x_pos_array: # measure at a few x positions
            ...
            for i, th in enumerate(th_meas): #loop over incident angles
                ...
                sample_name = name_fmt.format(
                            sample = sample, th=th_real[i],  x=np.round(piezo.x.position,2), y=np.round(piezo.y.position,2), 
                            z=np.round(piezo.z.position,2),  saxs_z=np.round(pil1m_pos.z.position,2), 
                            t=t, scan_id=RE.md['scan_id'])  
                sample_id(user_name=  username , sample_name=sample_name)                     
                print(f'\n\t=== Sample: {sample_name} ===\n')   
...
def run_giwaxs( x_list=x_list, sample_list=sample_list,   t=1, username =  username, inc_angles=[  0.05, 0.15, 0.3 ], waxs_angles = [ 0, 20   ] ,
  x_shift_array = [ -500, -400, -300, -200, -100, 0, 100 , 200, 300, 400, 500 ]  , 
   saxs_on=True,): 
    # define names of samples on sample bar     
    assert len(x_list) == len(sample_list), f'Sample name/position list is borked'
