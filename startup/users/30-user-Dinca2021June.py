...
sample_dict = {
    ...
    7: "Wong_AgNRs1_1P2mM",
    8: "Wong_AgNRs2_1P0mM",
    9: "Wong_AgNRs2_1P25mM",
    10: "Wong_AgNRs2_1P5mM",
    12: "Wong_AgNRs1_1P5mM",
    13: "Wong_AgNRs2_1P75mM",
    14: "Wong_AgNRs2_2P0mM",
}
...
sample_dict = {
    3: "Wong_AgNRs1_1P2mM_t10",
    4: "Wong_AgNRs1_1P2mM_t20",
    5: "Wong_AgNRs1_1P2mM_t30",
    6: "Wong_AgNRs1_1P2mM_t45",
    7: "Wong_AgNRs1_1P2mM_t60",
    8: "Wong_AgNRs1_0P6mM_t10",
    9: "Wong_AgNRs1_0P6mM_t20",
    10: "Wong_AgNRs1_0P6mM_t30",
    11: "Wong_AgNRs1_0P6mM_t45",
    12: "Wong_AgNRs1_0P6mM_t60",
}
...
sample_dict = {
    1: "YG_Au10nm_PTFE_WT0P8mm",
    2: "YG_Au50nm_PTFE_WT0P8mm",
    3: "YG_Au10nm_PETF_WT20um",
    4: "YG_Au50nm_PETF_WT20um",
}
...
def measure_one_potential(sam_pos=1, t=1, V=""):
    ...
    RE(
        measure_waxs(
            t=t, waxs_angles=[0.0, 6.5, 13.0], saxs_on=True, inverse_angle=inverse_angle
        )
    )
    # time.sleep(3)
