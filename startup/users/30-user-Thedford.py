...
def run_swaxs_Fei_2022_3(t=1):
    ...
    # 1 sample row
    names_1   = [   'I1',   'I2',   'I3',   'I4',   'I5',   'I6',   'M1',   'M2',   'M3',   'M4',   'M5',   'M6',]
    piezo_x_1 = [ -54500, -44600, -35600, -26900, -18000,  -9100,   -200,   8700,  17600,  26500,  35400,  44300,]
    piezo_y_1 = [  -9700,  -9100,  -9100,  -9500,  -9000,  -9700,  -9700,  -9700,  -9700,  -9700,  -9700,  -9700,] 

    # 2 sample row
    names_2   = [   'J1',   'J2',   'J3',   'J4',   'J5',   'J6',   'N1',   'N2',   'N3',   'N4',   'N5',   'N6',]
    piezo_x_2 = [ -54400, -44800, -36300, -27400, -18500,  -9000,   -200,   8700,  17600,  26400,  35400,  44300,]
    piezo_y_2 = [  -4300,  -4300,  -4100,  -4500,  -4500,  -4500,  -4900,  -4900,  -4900,  -4900,  -4700,  -4700,]

    # 3 sample row
    names_3   = [   'K1',   'K2',   'K3',   'K4',   'K5',   'K6',   'O1',   'O2',   'O3',   'O4',   'O5',   'O6',]
    piezo_x_3 = [ -54400, -45100, -35900, -27500, -18600,  -9700,   -500,   8400,  17300,  26200,  35100,  44000,]
    piezo_y_3 = [    900,    900,    900,    900,    900,    900,    500,    500,    500,    500,    500,    500,]

    # 4 sample row
    names_4   = [   'L1',   'L2',   'L3',   'L4',   'L5',   'L6',   'P1',   'P2',   'P3',   'P4',   'P5',   'P6',]
    piezo_x_4 = [ -54300, -45000, -36100, -27400, -18500,  -9600,   -500,   8500,  17500,  26500,  35100,  44000,]
    piezo_y_4 = [   5600,   6000,   6200,   6000,   5600,   5600,   5700,   5500,   5500,   6000,   6000,   6000,]
