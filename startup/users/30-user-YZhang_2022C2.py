...
sample_dict =   {1: 'D5', 2: 'D4', 3: 'D3', 4: 'D2', 5: 'D1'  , 6: 'I9',  7: 'I8',  8: 'I7',  9: 'I6',  10: 'I5',
 11: 'I4',  12: 'I3',  13: 'I2',  14: 'I1',  15: 'S11',  16: 'S10',  17: 'S9',  18: 'S8',  19: 'S7',  20: 'S6',  21: 'S5',
 22: 'S4',  23: 'S3',  24: 'S2',  25: 'S1'}
...
def run_giwsaxs( x_list=x_list, sample_list=sample_list,   t=1, username =  username, 
  inc_angles=[  0.05, 0.1, 0.12,  0.15, 0.2,  0.3, .5 ], waxs_angles = [ 0, 10,  20   ] ,
  x_shift_array = [ -1000, 0, 1000 ]  ,     YPOS = {   },  ThPOS = {   },
...
def run_giwsaxs2( x_list=x_list, sample_list=sample_list,   t=1, username =  username, 
  inc_angles=[  0.05, 0.1, 0.12,  0.15, 0.2,  0.3, .5 ], waxs_angles = [ 0, 10,  20   ] ,
  x_shift_array = [ -1000, 0, 1000 ]  ,     YPOS = {   },  ThPOS = {   },
   saxs_on=True,    T=25    ): 
