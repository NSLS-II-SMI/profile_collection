...
def do_grazing(meas_t=1):
        ...
        names = ['bar2_C1a_250nm_sam1', 'bar2_C1a_250nm_sam2',  'bar2_C2B1_250nm_sam1',  'bar2_C2B1_250nm_sam2', 'bar2_Nafion_250nm_sam1', 'bar2_Nafion_250nm_sam2']       
...
def alignCai():
        ...
        yield from bps.mv(pil1M.roi1.min_xyz.min_y, 910-168) #168 px for 0.1deg at 8.3 m, 330px for 0.25deg at 6.5 m 97 for 6 m and 0.08
