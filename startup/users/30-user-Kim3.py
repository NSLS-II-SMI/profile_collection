...
################## 2021-June ################## 
# Bar 1
sample_list = [ 'Bar1_Sam01',  'Bar1_Sam02', 'Bar1_Sam03', 'Bar1_Sam04', 'Bar1_Sam05', 
                'Bar1_Sam06',  'Bar1_Sam07', 'Bar1_Sam08', 'Bar1_Sam09', 'Bar1_Sam10',  
                'Bar1_Sam11',  'Bar1_Sam12', 'Bar1_Sam13', 'Bar1_Sam14', 'Bar1_Sam15',
                'Bar1_Sam16'  ]

x_list = [      -47500,    -41500,  -35500, -29500, -23000,
                -18000,    -12000,  -6000,  1000, 8000,
                16000,      24000,  31000,  37000, 44000,
                50000
       ]

# Bar 2
sample_list = [ 'Bar2_Sam17',  'Bar2_Sam18', 'Bar2_Sam19', 'Bar2_Sam20', 'Bar2_Sam21', 
                'Bar2_Sam22',  'Bar2_Sam23', 'Bar2_Sam24', 'Bar2_Sam25', 'Bar2_Sam26',  
                'Bar2_Sam27',  'Bar2_Sam28', 'Bar2_Sam29', 'Bar2_Sam30', 'Bar2_Sam31'
                ]

x_list = [      -48000,  -41000, -35000,   -27000, -19000, 
                -12000, -5000,  3000, 10500, 16500,
                22500,  28000, 35000, 42000, 49000
       ]

# Bar 3
sample_list = [ 'Bar3_Sam33', 'Bar3_Sam34', 'Bar3_Sam35', 'Bar3_Sam36', 'Bar3_Sam37',  
                'Bar3_Sam38', 'Bar3_Sam39', 'Bar3_Sam40', 'Bar3_Sam41', 'Bar3_Sam42',  
                'Bar3_Sam43', 'Bar3_Sam44', 'Bar3_Sam45', 'Bar3_Sam46','Bar3_Sam47',  
                'Bar3_Sam48', 'Bar3_Sam49', 'Bar3_Sam50', 'Bar3_Sam51','Bar3_Sam52',  
                'Bar3_Sam32', 
                ]

x_list = [-56000,  -50000, -44000, -38000, -32000,
        -26000, -20000, -15000, -8000, -2000,
        3000,  9000, 14000, 22000, 28000,
        33500, 37500, 42500, 48000, 53500, 
        59500
       ]

# Bar 4
sample_list = [ 'Bar4_Sam53', 'Bar4_Sam54', 'Bar4_Sam55', 'Bar4_Sam56', 'Bar4_Sam57',  
                'Bar4_Sam58', 'Bar4_Sam59', 'Bar4_Sam60', 'Bar4_Sam61', 'Bar4_Sam62',
                'Bar4_Sam63', 'Bar4_Sam64', 'Bar4_Sam65', 'Bar4_Sam66', 'Bar4_Sam67',
                'Bar4_Sam68', 'Bar4_Sam69', 'Bar4_Sam70', 'Bar4_Sam71', 
                ]

x_list = [  59000, 54000, 48000, 43000, 36000,
            30000, 24000, 18000, 11000, 5000, 
            -2000, -6000, -13000, -19000, -24000,
            -31000, -41000, -46000, -52000
       ]
...
def run_giwaxs_Kim(t=1, username = 'Kim'): 
    ...
    waxs_angle_array = np.linspace(0, 45.5, 8) # 4*3.14/(12.39842/16.1)*np.sin((7*6.5+3.5)*3.14/360) = 6.760 A-1
