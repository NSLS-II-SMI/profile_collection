...
def run_giwaxs_ZB(t=0.5):
    ...
    sample_list = [
        "YG_Au5nm_930nM"
    ]  # ,   'YG_Au10nm_486nM',   'YG_FeO_10nm_SHS_Wat'   ]
...
def run_giwaxs_Taylor(t=0.5):
    ...
    sample_list = [
        ...
        "S2_P3SIS_1p10_40mgml_Drop",
        "S3_P3PS_1p10_6mgml_Drop3",
        "S4_P3SIS_1p10_6mgml_Drop",
        "S5_P3PS_1p10_6mgml_Spin",
        "S6_P3SIS_1p10_6mgml_Spin",
        "JM17",
    ]
    x_list = [
        -33000,
...
def measure_saxs(
    ...
    dets = [pil1M]
    name_fmt = (
        "{sample}_x{x_pos}_y{y_pos}_sax{saxs_z}m_{meas_t}s_{att}_att_{scan_id}_sid"
    )
    sample_name = name_fmt.format(
        sample=sample,
        x_pos=np.round(piezo.x.position, 2),
