...
def overnight_discharge_charge(
    sam, t=2, N=96, sleep_time=10 * 60, waxs_angles=[0, 20, 40]
):
...
def overnight_discharge_charge_new(
    sam, t=2, N=72, sleep_time=10 * 60, waxs_angles=[0, 20, 40]
):
...
def measure_series_multi_angle_wsaxs(
    t=[1], waxs_angles=[0, 10, 20, 40], dys=[0, -500, -500]
):
...
def measure_series_multi_angle_wsaxs_PNNL(
    t=[0.02, 0.05, 0.1, 0.2, 0.5, 1, 10],
    waxs_angles=[40, 20, 0],
):
