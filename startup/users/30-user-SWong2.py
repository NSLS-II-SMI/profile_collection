...
sample_dict = {   1: 'KBr_1_min',  2: 'KBr_2_min',  3:  'KBr_5_min', 4:  'KBr_15_min', 5:  'KBr_30_min', 6:  'KBr_45_min',
7:  'KBr_90_min',  8 :  'KBr_120_min', 9 :  'KBr_240_min', 10 :  'KBr_480_min',  11: 'Oleylamine', 12: 'CTAB_30s',
13:  'CTAB_1min', 14:  'CTAB_2min',  15: 'CTAB_5min' }
pxy_dict = {  1: (42300,  -1700),  2: (  39500, -1700 ),  3: ( 33600, 0  ), 4: ( 25400 , 0  ), 5:( 19300, -1176 ) , 
6: ( 12200, -2400 ),  7: ( 7200 , 0 ), 8: ( 500, -3000  ),   9: ( -4300, 2416  ), 
10: ( -8300,  400 ), 11: ( -15900, -2600), 12: ( -20500, -6100  ), 13: ( -27400, -7600   ), 14: ( -33700, 0   ), 
15: ( -40800, 2000 ),    }
...
# Second run,
sample_dict = {   1: 'CTAB_10min',  2: 'CTAB_15min',  3:  'CTAB_30min', 4:  'CTAB_45min', 5:  'CTAB_60min', 6:  'CTAB_90min',
7:  'CTAB_120min',  8 :  'CTAB_240min', 9 :  'CTAB_480min', 10 :  'NoCTAB',  11: 'NoPt_acac2', 12: 'NoMoCO6',
13:  'ML_0.09uM', 14:  'ML_0.45uM',  15: 'ML_0.9uM' }

pxy_dict = {  1: (42400,  -1700),  2: ( 37300, 0 ),  3: ( 32100, -1000  ), 4: ( 25900 ,2000  ),
 5:( 18600, -1176 ) , 6: ( 13600, 1000  ),  7: ( 9100, -2000 ),  8: ( 3200, 0  ),   
  9: ( -3200, 0  ), 10: ( -9100, 2000 ), 11: ( -14600, -4700),  
  12: ( -22800, -2500  ),   
  13: ( -29600, 2500  ), 14: ( -35100, -3000   ), 15: (-41700, 5000 ),    }


sample_dict = {   13:  'ML_0.09uM', 14:  'ML_0.45uM',  15: 'ML_0.9uM' }
pxy_dict = {    13: ( -29600, 2500  ), 14: ( -35100, -3000   ), 15: (-41700, 5000 ),    }
...
pxy_dict = {   3: ( 32400, 1000  ), 4: ( 25400 ,500  ),   }
...
sample_dict = {  1: 'FL_CapDia2mm',    }
#sample_dict = {  1: 'FL_CuC_CapDia2mm',    }

sample_dict = {  1: 'FL_CapDia1mm',    }
...
def measure_series_wsaxs(  t= [  1 ] , waxs_angle=20,  dys = [0, -500, -1000, -1500, -2000,  ]   ):
    ks = list( sample_dict.keys() )  
    for k in ks:
        mov_sam( k )                   
        for dy in dys: 
...
def measure_waxs_loop_sample( t = .5, att='None', move_y=False, user_name='',  
                              saxs_on = True,   waxs_angles =   [0, 20 ], inverse_angle = False   ):    
        ...
        for pos in ks:
            ...
            if saxs_on:
                if waxs_angle == max_waxs_angle:
                    dets = [ pil1M, pil300KW, pil900KW  ] # waxs, maxs, saxs = [pil300KW, rayonix, pil1M]                
                else:
