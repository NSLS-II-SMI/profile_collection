...
4: 'HZ2_S24_PEG2K_Au20_SilOil_500mMNaCl_R1', 5: 'HZ2_S25_PEG2K_Au10_SilOil_10mMNaCl_tubingD_356', 6: 'HZ2_S26_PEG2K_Au10_SilOil_10mMNaCl_tubingD_3000', 
7: 'HZ2_S27_PEG2K_Au10_SilOil_10mMNaCl_tubingD_223' , 
8: 'HZ3_S31_PEG2K_Au10_SilOil_100mMNaCl_100nM',  9: 'HZ3_S32_PEG2K_Au10_SilOil_100mMNaCl_20nM', 10: 'HZ3_S33_PEG2K_Au10_OA_100mMNaCl_20nM',
11: 'HZ3_S34_PEG2K_Au10_BuOH_100mMNaCl_20nM',12: 'HZ3_S35_PEG2K_Au10_SilOil_10mMNaCl_20nM', 13: 'HZ3_S36_PEG2K_Au10_SilOil_500mMNaCl_20nM',   }
pxy_dict = {  1:  ( 37400, -8200), 2:  ( 30000, -7500),  3:  ( 22200, -4500  ), 4:  ( 15800, -4300), 5:  ( 7200, -7000), 6:  ( -2200, -6000), 
7:  ( -10200, -7500),  8: ( -16900, -3000  ), 9: (-22500, -3660 ), 10: ( -28800, -2460), 11: (-33100, -2200 ),
12: ( -37200, -4600 ), 13: ( -41100, -5300  ) 
    }
...
def measure_saxs_scany( N ,t=1, user_name='HZ', sample= None, att='None', ): 
    ...
    for i in range(N):                 
        ...
        yield from   bps.mvr(piezo.y, 30)  #here is something wrong, should move a relative postion, have to redo this y scan!!!! NOTE at Thursady afternoon (9/23)
