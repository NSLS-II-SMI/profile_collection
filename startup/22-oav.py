...
OAV_writing.tiff.write_path_template = '/nsls2/data/smi/legacy/data/%Y/%m/%d/'
OAV_writing.tiff.read_path_template = '/nsls2/data/smi/legacy/data/%Y/%m/%d/'
OAV_writing.tiff.reg_root = '/nsls2/data/smi/legacy/data/'
